...
- Связанные карточки: BL-2026-025, BL-2026-026, BL-2026-027, BL-2026-028, BL-2026-029, BL-2026-030
...
- Уверенность анализа: высокая для границ; средняя для DTO и endpoint names до подтверждения фактической модели
...
### Ограничение по исходным карточкам

BL-2026-025…030 не найдены в текущей ветке и среди доступных git refs по указанным ID; их тексты недоступны для чтения. В эту карточку перенесены названия из поручения и аналитический вывод `hrm-hunttech-analyst`. Поэтому обязательные поля, статусы, точные имена сущностей, приоритеты и критерии исходных карточек требуют подтверждения и не выдаются за факты.
...
- Исходные карточки BL-2026-025…030 не удалялись, не переносились и не переписывались.
...
- README/index backlog не обновлялся: в текущей ветке `.ai/backlog/README.md` отсутствует.
...
- 2026-09-23 — руководитель подтвердил выполнение подпроекта; карточка выведена из активного backlog и перенесена в архив.
