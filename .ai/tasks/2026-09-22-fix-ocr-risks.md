...
2. MarkdownRenderer: продолжение таблицы требует совпадающего количества колонок и стиля внешних pipe; single-column таблицы сохранены; произвольная строка с pipe закрывает таблицу.
