...
- **Авторизация в HRM через CDP / браузер**: перед вводом логина и пароля ВСЕГДА полностью стирать старые данные в полях ввода на логинскрине. Учётные записи:
  - Администратор: логин `admin`, пароль `admin`
  - Management: логин `alan`, пароль `Dodo-2012`
