...
| Stage 11 JobCandidateEdit | [контракт фоновой загрузки рейтинга](performance-archive/2026-07-15/job-candidate-rating-stage-11-background-load/stage-11-rating-background-load-contract.md) |
