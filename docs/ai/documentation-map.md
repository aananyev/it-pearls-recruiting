...
| Проверить бизнес-правила | `docs/business-rules/` | [job-candidate-company-selection.md](../business-rules/job-candidate-company-selection.md), [user-settings-photo-sync.md](../business-rules/user-settings-photo-sync.md), [job-candidate-activity-roles.md](../business-rules/job-candidate-activity-roles.md) |
