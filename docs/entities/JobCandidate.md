...
| `iteractionList` | **BATCH** | inline: `rating`, `dateIteraction`, `comment`, `recrutier` `_minimal` | Рейтинг, lastIteraction |
...
| `interactionCommentDc` | Collection `IteractionList` | `_minimal` + comment fields | да | Вкладка комментариев |
