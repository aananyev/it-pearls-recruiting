...
`hunttech_City.browse`, `hunttech_City.edit`; picker `city-picker-view` / `city-location-view` в Company, JobCandidate, OpenPosition. UI Spec: [browse](../../screens/city/hunttech_City.browse_Spec.md), [edit](../../screens/city/hunttech_City.edit_Spec.md).
