...
`hunttech_CompanyGroup.browse`, `hunttech_CompanyGroup.edit`; FK `companyGroup` на `Company`. UI Spec: [browse](../../screens/company-group/hunttech_CompanyGroup.browse_Spec.md), [edit](../../screens/company-group/hunttech_CompanyGroup.edit_Spec.md).
