...
Загрузка в оба слота проходит через [ImageProcessingService](../../services/file-storage/ImageProcessingService.md) (сжатие/масштабирование по `HunttechImageConfig`).
...
| Дата | Изменение |
|------|-----------|
| 2026-06-29 | Документация: cross-link на [ImageProcessingService](../../services/file-storage/ImageProcessingService.md) для обработки загружаемых фото |
