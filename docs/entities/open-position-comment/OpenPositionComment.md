...
`hunttech_OpenPositionComment.browse`, `hunttech_OpenPositionComment.edit`; вкладка/попап в OpenPositionBrowse и Edit. UI Spec: [browse](../../screens/open-position-comment/hunttech_OpenPositionComment.browse_Spec.md), [edit](../../screens/open-position-comment/hunttech_OpenPositionComment.edit_Spec.md).
