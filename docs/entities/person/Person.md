...
`hunttech_Person.browse`, `hunttech_Person.edit`; lookup в Project, OpenPosition (через projectOwner). UI Spec: [browse](../../screens/person/hunttech_Person.browse_Spec.md), [edit](../../screens/person/hunttech_Person.edit_Spec.md).
...
- [Project](../project/Project.md) — планируется
