...
`hunttech_Region.browse`, `hunttech_Region.edit`; FK `country`, дочерние `City`. UI Spec: [browse](../../screens/region/hunttech_Region.browse_Spec.md), [edit](../../screens/region/hunttech_Region.edit_Spec.md).
