# CompanyGroup Browse (`hunttech_CompanyGroup.browse`)

> Сущность: [CompanyGroup.md](../../entities/company-group/CompanyGroup.md)
...
Контроллер `hunttech_CompanyGroup.browse`; навигация и дочерние формы — §3 «Иерархия и взаимосвязь форм».
...
| **Java-класс** | `com.company.hunttech.web.screens.companygroup.CompanyGroupBrowse ` |
| **XML-дескриптор** | `company-group-browse.xml` |
| **messagesPack** | `com.company.hunttech.web.screens.companygroup` |
| **Базовый класс** | `StandardLookup` |
| **Lookup-компонент** | `companyGroupsTable` |
| **EditedEntityContainer** | `` |
| **focusComponent** | `companyGroupsTable` |
| **Меню** | `web-menu.xml` → `screen="hunttech_CompanyGroup.browse"` (если есть пункт) |
...
```
select e from hunttech_CompanyGroup e
```
...
| Парный экран | `hunttech_CompanyGroup.edit` | create / edit action |
...
| Элемент | Источник |
|---------|----------|
| Caption | `msg://` / `mainMsg://` из `com.company.hunttech.web.screens.companygroup` |
