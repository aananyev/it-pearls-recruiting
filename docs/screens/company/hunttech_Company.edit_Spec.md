...
| Дата | Изменение |
|------|-----------|
| 2026-08-22 | Добавлен вызов мастера умного автозаполнения компании (`smartFillCompanyBtn`, `smartFillCompanyTabBtn`) с поиском в интернете по наименованию и ИНН, выбором из нескольких кандидатов и автозаполнением реквизитов, контактов, адреса и описания |
