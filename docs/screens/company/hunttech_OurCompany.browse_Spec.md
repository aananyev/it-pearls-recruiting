# Company Browse (`hunttech_OurCompany.browse`)
...
Контроллер `hunttech_OurCompany.browse`; навигация и дочерние формы — §3 «Иерархия и взаимосвязь форм».
...
| **Java-класс** | `com.company.hunttech.web.screens.company.OurCompanyBrowse ` |
...
| **focusComponent** | `` |
| **Меню** | `web-menu.xml` → `screen="hunttech_OurCompany.browse"` (если есть пункт) |
