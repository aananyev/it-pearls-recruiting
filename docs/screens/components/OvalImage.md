...
> См. также: [FallbackImage](FallbackImage.md) — placeholder для пустого `image`; [OvaFallbackImage](OvaFallbackImage.md) — **объединённый** компонент (круг + fallback в одном теге).
...
- [ImageProcessingService](../../services/file-storage/ImageProcessingService.md) — сжатие и лимиты фото профиля
- [ExtUser](../../entities/ext-user/ExtUser.md) — поле `officialPhoto`, экраны с аватарами
