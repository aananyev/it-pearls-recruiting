# Country Browse (`hunttech_Country.browse`)
...
Контроллер `hunttech_Country.browse`; навигация и дочерние формы — §3 «Иерархия и взаимосвязь форм».
...
| **Java-класс** | `com.company.hunttech.web.screens.country.CountryBrowse ` |
...
| **Меню** | `web-menu.xml` → `screen="hunttech_Country.browse"` (если есть пункт) |
...
| Парный экран | `hunttech_Country.edit` | create / edit action |
