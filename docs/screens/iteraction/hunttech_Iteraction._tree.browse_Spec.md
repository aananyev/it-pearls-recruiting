# Iteraction Browse (`hunttech_Iteraction._tree.browse`)
...
Контроллер `hunttech_Iteraction._tree.browse`; навигация и дочерние формы — §3 «Иерархия и взаимосвязь форм».
...
| Параметр | Значение |
|----------|----------|
| **@UiController** | `hunttech_Iteraction._tree.browse` |
| **Java-класс** | `com.company.hunttech.web.screens.iteraction.IteractionTreeBrowse ` |
...
| **Меню** | `web-menu.xml` → `screen="hunttech_Iteraction._tree.browse"` (если есть пункт) |
