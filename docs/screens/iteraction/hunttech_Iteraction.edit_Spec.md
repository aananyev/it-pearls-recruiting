# Iteraction Edit (`hunttech_Iteraction.edit`)
...
Контроллер `hunttech_Iteraction.edit`; навигация и дочерние формы — §3 «Иерархия и взаимосвязь форм».
...
| **Java-класс** | `com.company.hunttech.web.screens.iteraction.IteractionEdit ` |
...
| **Меню** | `web-menu.xml` → `screen="hunttech_Iteraction.edit"` (если есть пункт) |
...
```
select e from hunttech_EmployeeWorkStatus e order by e.workStatusName
```
...
| Парный экран | `hunttech_Iteraction.browse` | create / edit action |
