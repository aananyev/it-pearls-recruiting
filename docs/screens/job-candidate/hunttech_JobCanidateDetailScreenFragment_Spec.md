# JobCandidate Detail Fragment (`hunttech_JobCanidateDetailScreenFragment`)
...
Контроллер `hunttech_JobCanidateDetailScreenFragment`; навигация и дочерние формы — §3 «Иерархия и взаимосвязь форм».
...
| **Java-класс** | `com.company.hunttech.web.screens.jobcandidate.JobCanidateDetailScreenFragment` |
...
```mermaid
flowchart TD
    Browse[hunttech_JobCandidate.browse] -->|detailsGenerator| Fragment[hunttech_JobCanidateDetailScreenFragment]
