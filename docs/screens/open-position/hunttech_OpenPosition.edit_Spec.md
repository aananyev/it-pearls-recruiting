# OpenPosition Edit (`hunttech_OpenPosition.edit`)
...
Из `hunttech_OpenPosition.browse` и master/recruiting browse; pickers Project, Position, Grade, City, parent OpenPosition.
...
| **Java-класс** | `com.company.hunttech.web.screens.openposition.OpenPositionEdit` |
...
```mermaid
flowchart TD
    Browse[hunttech_OpenPosition.browse] --> Edit[hunttech_OpenPosition.edit]
    Edit --> PositionEdit[Position.edit]
    Edit --> SelectCities[hunttech_SelectCitiesLocation]
...
| Города | `hunttech_SelectCitiesLocation` | множественный выбор локации |
