# OpenPosition Detail Fragment (`hunttech_OpenPositionDetailScreenFragment`)
...
Контроллер `hunttech_OpenPositionDetailScreenFragment`; навигация и дочерние формы — §3 «Иерархия и взаимосвязь форм».
...
| Параметр | Значение |
|----------|----------|
| **@UiController** | `hunttech_OpenPositionDetailScreenFragment` |
| **Java-класс** | `com.company.hunttech.web.screens.openposition.openpositionfragments.OpenPositionDetailScreenFragment` |
...
```mermaid
flowchart TD
    Browse[hunttech_OpenPosition.browse] -->|detailsGenerator| Fragment[hunttech_OpenPositionDetailScreenFragment]
    Outstaff[hunttech_OpenPositionOutstaff.browse] -->|extends| Fragment
