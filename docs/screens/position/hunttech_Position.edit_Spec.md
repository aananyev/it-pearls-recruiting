# Position Edit (`hunttech_Position.edit`)
...
Контроллер `hunttech_Position.edit`; навигация и дочерние формы — §3 «Иерархия и взаимосвязь форм».
...
| **Java-класс** | `com.company.hunttech.web.screens.position.PositionEdit ` |
...
| **Меню** | `web-menu.xml` → `screen="hunttech_Position.edit"` (если есть пункт) |
...
| Парный экран | `hunttech_Position.browse` | create / edit action |
