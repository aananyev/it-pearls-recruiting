# RecrutiesTasks Browse (`hunttech_RecrutiesTasks.browse`)
...
Контроллер `hunttech_RecrutiesTasks.browse`; навигация и дочерние формы — §3 «Иерархия и взаимосвязь форм».
...
| Параметр | Значение |
|----------|----------|
| **@UiController** | `hunttech_RecrutiesTasks.browse` |
| **Java-класс** | `com.company.hunttech.web.screens.recrutiestasks.RecrutiesTasksBrowse ` |
| **XML-дескриптор** | `recruties-tasks-browse.xml` |
| **messagesPack** | `com.company.hunttech.web.screens.recrutiestasks` |
...
| **Меню** | `web-menu.xml` → `screen="hunttech_RecrutiesTasks.browse"` (если есть пункт) |
...
| Элемент | Источник |
|---------|----------|
| Caption | `msg://` / `mainMsg://` из `com.company.hunttech.web.screens.recrutiestasks` |
