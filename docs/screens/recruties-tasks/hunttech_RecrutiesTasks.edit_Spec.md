# RecrutiesTasks Edit (`hunttech_RecrutiesTasks.edit`)
...
Контроллер `hunttech_RecrutiesTasks.edit`; навигация и дочерние формы — §3 «Иерархия и взаимосвязь форм».
...
| Параметр | Значение |
|----------|----------|
| **@UiController** | `hunttech_RecrutiesTasks.edit` |
| **Java-класс** | `com.company.hunttech.web.screens.recrutiestasks.RecrutiesTasksEdit ` |
...
| **focusComponent** | `` |
| **Меню** | `web-menu.xml` → `screen="hunttech_RecrutiesTasks.edit"` (если есть пункт) |
...
| Парный экран | `hunttech_RecrutiesTasks.browse` | create / edit action |
