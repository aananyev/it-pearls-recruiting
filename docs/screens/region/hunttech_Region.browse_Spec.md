# Region Browse (`hunttech_Region.browse`)
...
Контроллер `hunttech_Region.browse`; навигация и дочерние формы — §3 «Иерархия и взаимосвязь форм».
...
| **Java-класс** | `com.company.hunttech.web.screens.region.RegionBrowse ` |
...
| **Меню** | `web-menu.xml` → `screen="hunttech_Region.browse"` (если есть пункт) |
...
| Парный экран | `hunttech_Region.edit` | create / edit action |
