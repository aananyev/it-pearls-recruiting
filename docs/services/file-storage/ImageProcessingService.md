...
**Связанные документы:** [ExtUser](../../entities/ext-user/ExtUser.md) (слоты фото) · UI: [ExtUserEdit](../../screens/ext-user/hunttech_ExtUserEdit_Spec.md) · [ExtSettingsWindow](../ui/ExtSettingsWindow_Spec.md) *(при наличии)*
