...
Sidebar-иллюстрация: `ovaFallbackImage` отображается 176×176 и использует отдельный theme asset `icons/ai/ai-function-configuration.png` размером 200×200. Графика выполнена в фирменной чёрно-серо-бело-красной палитре HRM HuntTech: HuntTech-монограмма объединена с AI/network, prompt/document и sliders, чтобы визуально показывать назначение формы — конфигурацию AI-функции.

## История изменений

| Дата | Изменение |
|---|---|
| 2026-08-13 | Общий fallback `icons/hunttech-logo.png` заменён на тематическую иллюстрацию AI-функции `icons/ai/ai-function-configuration.png`: исходный asset 200×200, отображение `ovaFallbackImage` сохранено 176×176 |
