...
| Дата | Изменение |
|---|---|
| 2026-08-12 | Аватар `userPic` приведён к размеру 176×176 (width/height/ovalWidth/ovalHeight в XML + SCSS `.ext-user-editor-avatar` во всех 7 темах) — в точности как `candidatePic` эталона JobCandidateEdit. |
...
└── mainSplit.edit-screen-layout (100% × 100%)
    ...
    │   ├── dropZone.edit-sidebar-visual (OvaFallbackImage 176×176 + upload)
