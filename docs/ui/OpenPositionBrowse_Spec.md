...
| 2026-08-20 | Актуализация спецификации; разработана архитектурная концепция Split-View формы нового поколения `OpenPositionReestrBrowse` (на базе `JobCandidateReestr` с сайдбаром 312px, логотипами проектов и единой выпадающей кнопкой фильтрации) и спецификация AI-сервиса `SmartOpenPositionIngestService` для умного создания вакансий и проектов. |
