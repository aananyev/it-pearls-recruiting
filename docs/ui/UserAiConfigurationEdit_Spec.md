...
| Дата | Изменение |
|---|---|
| 2026-09-23 | BL-2026-021: в `UserAiConfigurationEdit` внедрен fallback на текущего пользователя сессии при создании новой конфигурации без `parentUser`; в сайдбаре отображается логин владельца (`user.login`) |
