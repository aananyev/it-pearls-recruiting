# City Browse (`hunttech_City.browse`)
...
Контроллер `hunttech_City.browse`; навигация и дочерние формы — §3 «Иерархия и взаимосвязь форм».
...
| **Java-класс** | `com.company.hunttech.web.screens.city.CityBrowse ` |
...
| **Меню** | `web-menu.xml` → `screen="hunttech_City.browse"` (если есть пункт) |
...
| Парный экран | `hunttech_City.edit` | create / edit action |
