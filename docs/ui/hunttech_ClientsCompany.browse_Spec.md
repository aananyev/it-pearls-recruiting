# Company Browse (`hunttech_ClientsCompany.browse`)
...
Контроллер `hunttech_ClientsCompany.browse`; навигация и дочерние формы — §3 «Иерархия и взаимосвязь форм».
...
| Параметр | Значение |
|----------|----------|
| **@UiController** | `hunttech_ClientsCompany.browse` |
| **Java-класс** | `com.company.hunttech.web.screens.company.ClientsCompanyBrowse ` |
...
| **focusComponent** | `` |
| **Меню** | `web-menu.xml` → `screen="hunttech_ClientsCompany.browse"` (если есть пункт) |
...
| Парный экран | `hunttech_Company.edit` | create / edit action |
