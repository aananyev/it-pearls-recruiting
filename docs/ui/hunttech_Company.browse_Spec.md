# Company Browse (`hunttech_Company.browse`)
...
Контроллер `hunttech_Company.browse`; навигация и дочерние формы — §3 «Иерархия и взаимосвязь форм».
...
| **Java-класс** | `com.company.hunttech.web.screens.company.CompanyBrowse ` |
...
| **Меню** | `web-menu.xml` → `screen="hunttech_Company.browse"` (если есть пункт) |
