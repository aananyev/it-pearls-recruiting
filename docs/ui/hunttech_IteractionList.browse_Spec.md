# IteractionList Browse (`hunttech_IteractionList.browse`)
...
Контроллер `hunttech_IteractionList.browse`; навигация и дочерние формы — §3 «Иерархия и взаимосвязь форм».
...
| Параметр | Значение |
|----------|----------|
| **@UiController** | `hunttech_IteractionList.browse` |
| **Java-класс** | `com.company.hunttech.web.screens.iteractionlist.IteractionListBrowse ` |
...
| **Меню** | `web-menu.xml` → `screen="hunttech_IteractionList.browse"` (если есть пункт) |
