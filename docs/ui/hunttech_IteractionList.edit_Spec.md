...
Контроллер `hunttech_IteractionList.edit`; навигация и дочерние формы — §3 «Иерархия и взаимосвязь форм».
...
| **focusComponent** | `` |
| **Меню** | `web-menu.xml` → `screen="hunttech_IteractionList.edit"` (если есть пункт) |
...
| Парный экран | `hunttech_IteractionList.browse` | create / edit action |
