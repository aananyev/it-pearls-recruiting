# IteractionList Fragment (`hunttech_IteractionListBrowse`)
...
Контроллер `hunttech_IteractionListBrowse`; навигация и дочерние формы — §3 «Иерархия и взаимосвязь форм».
...
| Параметр | Значение |
|----------|----------|
| **@UiController** | `hunttech_IteractionListBrowse` |
| **Java-класс** | `com.company.hunttech.web.screens.jobcandidate.IteractionListBrowse` |
...
| Полный browse | `hunttech_IteractionList.browse` | menu |
| Редактирование | `hunttech_IteractionList.edit` | из родителя / browse |
