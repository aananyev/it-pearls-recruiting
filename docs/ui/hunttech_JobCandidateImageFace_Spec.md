# JobCandidate Image Face (`hunttech_JobCandidateImageFace`)
...
Контроллер `hunttech_JobCandidateImageFace`; навигация и дочерние формы — §3 «Иерархия и взаимосвязь форм».
...
| Параметр | Значение |
|----------|----------|
| **@UiController** | `hunttech_JobCandidateImageFace` |
| **Java-класс** | `com.company.hunttech.web.screens.jobcandidate.JobCandidateImageFace` |
...
```mermaid
flowchart LR
    Browse[hunttech_JobCandidate.browse] -->|click photo| Dialog[hunttech_JobCandidateImageFace]
```
