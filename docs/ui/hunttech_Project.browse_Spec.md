# Project Browse (`hunttech_Project.browse`)
...
Контроллер `hunttech_Project.browse`; навигация и дочерние формы — §3 «Иерархия и взаимосвязь форм».
...
| **Java-класс** | `com.company.hunttech.web.screens.project.ProjectBrowse ` |
...
| **Меню** | `web-menu.xml` → `screen="hunttech_Project.browse"` (если есть пункт) |
...
| Парный экран | `hunttech_Project.edit` | create / edit action |
