...
Контроллер `hunttech_SkillTree.edit`; навигация и дочерние формы — §3 «Иерархия и взаимосвязь форм».
...
| **Java-класс** | `com.company.hunttech.web.screens.skilltree.SkillTreeEdit ` |
...
| **focusComponent** | `` |
| **Меню** | `web-menu.xml` → `screen="hunttech_SkillTree.edit"` (если есть пункт) |
...
| Парный экран | `hunttech_SkillTree.browse` | create / edit action |
