...
create index IDX_ITPEARLS_USER_AI_CONFIGURATION_ON_USER on ITPEARLS_USER_AI_CONFIGURATION (USER_ID)^
...
create unique index IDX_ITPEARLS_VACANCY_PROMPT_TEMPLATE_UK_CODE on ITPEARLS_VACANCY_PROMPT_TEMPLATE (CODE) where DELETE_TS is null ^
