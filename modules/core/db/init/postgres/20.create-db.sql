...
create index IDX_ITPEARLS_JOB_CANDIDATE_PERSON_POSITION on ITPEARLS_JOB_CANDIDATE (PERSON_POSITION_ID)^
create index IDX_ITPEARLS_JOB_CANDIDATE_FILE_IMAGE_FACE on ITPEARLS_JOB_CANDIDATE (FILE_IMAGE_FACE)^
create index IDX_ITPEARLS_JOB_CANDIDATE_FIRST_NAME on ITPEARLS_JOB_CANDIDATE (FIRST_NAME)^
create index IDX_ITPEARLS_JOB_CANDIDATE_CITY_OF_RESIDENCE on ITPEARLS_JOB_CANDIDATE (CITY_OF_RESIDENCE_ID)^
create index IDX_ITPEARLS_JOB_CANDIDATE_CURRENT_COMPANY on ITPEARLS_JOB_CANDIDATE (CURRENT_COMPANY_ID)^
...
alter table ITPEARLS_OPEN_POSITION_PARTNERS_PARTNERS_LINK add constraint FK_OPEPOSPARPAR_ON_PARTNERS foreign key (PARTNERS_ID) references ITPEARLS_COMPANY(ID)^
alter table ITPEARLS_OPEN_POSITION_PARTNERS_PARTNERS_LINK add constraint FK_OPEPOSPARPAR_ON_OPEN_POSITION_PARTNERS foreign key (OPEN_POSITION_PARTNERS_ID) references ITPEARLS_OPEN_POSITION(ID)^
