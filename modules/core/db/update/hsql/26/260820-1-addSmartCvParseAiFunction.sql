-- HRM HuntTech: seed AI-функции CV_SMART_PARSE_JSON (SmartCvIngestService) для HSQL.
...
SELECT
    'b2e4c6a8-1d3f-4e5a-8b7c-9f0a1b2c3d4e',
    1,
    CURRENT_TIMESTAMP,
    'migration',
    'CV_SMART_PARSE_JSON',
    ...
    'Текст резюме для анализа:' || CHAR(10) || '${sourceText}',
    0.2,
    4000,
