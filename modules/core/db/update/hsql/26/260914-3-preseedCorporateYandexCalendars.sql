-- Pre-seed корпоративных Яндекс-календарей для HSQLDB
...
SELECT 
    '26091400-0000-4000-a000-000000000001',
    1,
    CURRENT_TIMESTAMP,
    'admin',
    CURRENT_TIMESTAMP,
...
SELECT 
    '26091400-0000-4000-a000-000000000002',
    1,
    CURRENT_TIMESTAMP,
    'admin',
    CURRENT_TIMESTAMP,
...
SET OAUTH_TOKEN_ENCRYPTED = (SELECT c.OAUTH_TOKEN_ENCRYPTED FROM HUNTTECH_USER_YANDEX_CONFIG c JOIN SEC_USER u ON u.ID = c.USER_ID WHERE lower(u.LOGIN) = 'alan' AND c.DELETE_TS IS NULL AND u.DELETE_TS IS NULL)
