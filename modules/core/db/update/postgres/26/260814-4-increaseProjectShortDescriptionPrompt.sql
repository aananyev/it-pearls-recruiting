-- HRM HuntTech: увеличение AI-генерации краткого описания проекта в 2 раза
-- (два предложения вместо одного, MAX_TOKENS 125 -> 250) для сред, где функция
-- PROJECT_SHORT_DESCRIPTION_GENERATE уже существует (результат 260814-3).
