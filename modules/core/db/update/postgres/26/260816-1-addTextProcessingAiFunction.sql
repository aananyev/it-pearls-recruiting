-- HRM HuntTech: production-safe seed AI-функций умного форматирования текста (TextProcessingService).
-- Скрипт INSERT-only и идемпотентный: существующие настройки не перезаписываются при повторном запуске.
