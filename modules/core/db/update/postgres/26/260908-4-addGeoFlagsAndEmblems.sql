-- 260908-4-addGeoFlagsAndEmblems.sql
-- Добавление внешних ключей на SYS_FILE для флагов стран и гербов городов/регионов
-- (fileFlag, fileCityEmblem, fileRegionEmblem) и недостающего атрибута regionEngName
