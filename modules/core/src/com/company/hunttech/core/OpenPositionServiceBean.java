...
public class OpenPositionServiceBean implements OpenPositionService {
       ...
       List<String> openPositionSet = null;
        ...
        try {
            ...
            try (Transaction tx = persistence.createTransaction()) {
                ...
                Query query = em.createQuery("select e from hunttech_OpenPosition e where not e.openClose = true");
    ...
    public OpenPosition getOpenPositionDefault() {
        ...
        try {
            openPosition = dataManager
                    .loadValue("select e from hunttech_OpenPosition e where e.vacansyName like \'"
    ...
    final static String MESSAGES_OPEN_POSITION_CLASS = "com.company.hunttech.web";
