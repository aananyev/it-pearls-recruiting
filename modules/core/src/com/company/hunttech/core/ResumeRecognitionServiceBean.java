...
public class ResumeRecognitionServiceBean implements ResumeRecognitionService {
    ...
    public String parseFirstName(String cvText) {
        String QUERY_NAMES_LIST = "select distinct e.firstName from hunttech_Candidates";
    ...
    public String parseSecondName(String cvText) {
        String QUERY_NAMES_LIST = "select distinct e.secondName from hunttech_Candidates";
    ...
    public String parseMiddleName(String cvText) {
        String QUERY_NAMES_LIST = "select distinct e.middleame from hunttech_Candidates";
