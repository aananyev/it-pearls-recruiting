package com.company.hunttech.core.telegrambot;
...
public class Utils {
    ...
    public static String getOpenPositionEditorURL(OpenPosition openPosition, String text) {
        ...
        sb.append("<a href=\"http://hr.HuntTech.ru:8080/hrm/open?screen=hunttech_OpenPosition.edit-")
    ...
    public static String getOpenPositionEditorURL(OpenPosition openPosition) {
        ...
        sb.append("http://hr.HuntTech.ru:8080/hrm/open?screen=")
                .append("hunttech_OpenPosition.edit")
                .append("&item=")
                .append("hunttech_OpenPosition-")
                .append(openPosition.getId().toString())
    ...
    public static List<RecrutiesTasks> getRecrutiesTasks() {
        return queryListResult("select e from hunttech_RecrutiesTasks e " +
    ...
    public static List<OpenPosition> getOpenPosition() {
        return queryListResult("select e from hunttech_OpenPosition e " +
    ...
    public static String getBotName() {
        return queryOneResult("select e.telegramBotName from hunttech_ApplicationSetup e " +
