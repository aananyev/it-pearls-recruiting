...
public class GeoBulkLoaderServiceBean implements GeoBulkLoaderService {
    ...
    private static final List<RegionLocalEntry> RU_REGIONS_LOCAL = Arrays.asList(
            new RegionLocalEntry("RU-AD", "Республика Адыгея", "Республика", "Майкоп", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/d/d2/Coat_of_arms_of_Adygea.svg"),
            new RegionLocalEntry("RU-AL", "Республика Алтай", "Республика", "Горно-Алтайск", "UTC+7", "https://upload.wikimedia.org/wikipedia/commons/c/cf/Coat_of_Arms_of_Altai_Republic.svg"),
            new RegionLocalEntry("RU-ALT", "Алтайский край", "Край", "Барнаул", "UTC+7", "https://upload.wikimedia.org/wikipedia/commons/c/cb/Coat_of_Arms_of_Altai_Krai_%28Latest_version%29.svg"),
            new RegionLocalEntry("RU-AMU", "Амурская область", "Область", "Благовещенск", "UTC+9", "https://upload.wikimedia.org/wikipedia/commons/1/15/Coat_of_arms_of_Amur_Oblast.svg"),
            new RegionLocalEntry("RU-ARK", "Архангельская область", "Область", "Архангельск", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/c/c9/Coat_of_Arms_of_Arkhangelsk_oblast.svg"),
            new RegionLocalEntry("RU-AST", "Астраханская область", "Область", "Астрахань", "UTC+4", "https://upload.wikimedia.org/wikipedia/commons/5/5a/Coat_of_arms_of_Astrakhan_Oblast.svg"),
            new RegionLocalEntry("RU-BA", "Республика Башкортостан", "Республика", "Уфа", "UTC+5", "https://upload.wikimedia.org/wikipedia/commons/2/26/Coat_of_arms_of_Bashkortostan.svg"),
            new RegionLocalEntry("RU-BEL", "Белгородская область", "Область", "Белгород", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/6/68/Coat_of_arms_of_Belgorod_Oblast.svg"),
            new RegionLocalEntry("RU-BRY", "Брянская область", "Область", "Брянск", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/b/bd/Coat_of_arms_of_Bryansk_Oblast.svg"),
            ...
            new RegionLocalEntry("RU-CE", "Чеченская Республика", "Республика", "Грозный", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/8/83/Coat_of_arms_of_Chechnya.svg"),
            new RegionLocalEntry("RU-CHE", "Челябинская область", "Область", "Челябинск", "UTC+5", "https://upload.wikimedia.org/wikipedia/commons/b/b8/Coat_of_arms_of_Chelyabinsk_Oblast.svg"),
            new RegionLocalEntry("RU-CHU", "Чукотский автономный округ", "Автономный округ", "Анадырь", "UTC+12", "https://upload.wikimedia.org/wikipedia/commons/7/7d/Coat_of_Arms_of_Chukotka.svg"),
            new RegionLocalEntry("RU-CU", "Чувашская Республика", "Республика", "Чебоксары", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/3/32/Coat_of_arms_of_Chuvashia.svg"),
            new RegionLocalEntry("RU-DA", "Республика Дагестан", "Республика", "Махачкала", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/e/e7/Coat_of_arms_of_Dagestan.svg"),
            new RegionLocalEntry("RU-IN", "Республика Ингушетия", "Республика", "Магас", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/a/a7/Coat_of_arms_of_Ingushetia.svg"),
            new RegionLocalEntry("RU-IRK", "Иркутская область", "Область", "Иркутск", "UTC+8", "https://upload.wikimedia.org/wikipedia/commons/7/7f/Coat_of_arms_of_Irkutsk_Oblast.svg"),
            new RegionLocalEntry("RU-IVA", "Ивановская область", "Область", "Иваново", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/a/a9/Coat_of_Arms_of_Ivanovo_Oblast.svg"),
            new RegionLocalEntry("RU-KAM", "Камчатский край", "Край", "Петропавловск-Камчатский", "UTC+12", "https://upload.wikimedia.org/wikipedia/commons/6/66/Coat_of_arms_of_Kamchatka_Krai.svg"),
            new RegionLocalEntry("RU-KB", "Кабардино-Балкарская Республика", "Республика", "Нальчик", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/6/6b/Coat_of_arms_of_Kabardino-Balkaria.svg"),
            new RegionLocalEntry("RU-KC", "Карачаево-Черкесская Республика", "Республика", "Черкесск", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/a/a6/Coat_of_arms_of_Karachay-Cherkessia.svg"),
            new RegionLocalEntry("RU-KDA", "Краснодарский край", "Край", "Краснодар", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/7/7e/Coat_of_arms_of_Krasnodar_Krai.svg"),
            new RegionLocalEntry("RU-KEM", "Кемеровская область", "Область", "Кемерово", "UTC+7", "https://upload.wikimedia.org/wikipedia/commons/1/10/Coat_of_arms_of_Kemerovo_Oblast.svg"),
            new RegionLocalEntry("RU-KGD", "Калининградская область", "Область", "Калининград", "UTC+2", "https://upload.wikimedia.org/wikipedia/commons/2/23/Coat_of_Arms_of_Kaliningrad_Oblast.svg"),
            new RegionLocalEntry("RU-KGN", "Курганская область", "Область", "Курган", "UTC+5", "https://upload.wikimedia.org/wikipedia/commons/c/cc/Coat_of_arms_of_Kurgan_Oblast.svg"),
            new RegionLocalEntry("RU-KHA", "Хабаровский край", "Край", "Хабаровск", "UTC+10", "https://upload.wikimedia.org/wikipedia/commons/3/32/Coat_of_arms_of_Khabarovsk_Krai.svg"),
            new RegionLocalEntry("RU-KHM", "Ханты-Мансийский автономный округ — Югра", "Автономный округ", "Ханты-Мансийск", "UTC+5", "https://upload.wikimedia.org/wikipedia/commons/e/eb/Coat_of_arms_of_Yugra_%28Khanty-Mansia%29.svg"),
            new RegionLocalEntry("RU-KIR", "Кировская область", "Область", "Киров", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/6/6e/Coat_of_arms_of_Kirov_Oblast.svg"),
            new RegionLocalEntry("RU-KK", "Республика Хакасия", "Республика", "Абакан", "UTC+7", "https://upload.wikimedia.org/wikipedia/commons/3/37/Coat_of_arms_of_Khakassia.svg"),
            new RegionLocalEntry("RU-KL", "Республика Калмыкия", "Республика", "Элиста", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/9/95/Coat_of_Arms_of_Kalmykia.svg"),
            new RegionLocalEntry("RU-KLU", "Калужская область", "Область", "Калуга", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/5/58/Coat_of_arms_of_Kaluga_Oblast.svg"),
            new RegionLocalEntry("RU-KO", "Республика Коми", "Республика", "Сыктывкар", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/f/fe/Coat_of_Arms_of_the_Komi_Republic.svg"),
            new RegionLocalEntry("RU-KOS", "Костромская область", "Область", "Кострома", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/5/5e/Coat_of_arms_of_Kostroma_Oblast.svg"),
            new RegionLocalEntry("RU-KR", "Республика Карелия", "Республика", "Петрозаводск", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/0/0d/Coat_of_arms_of_the_Republic_of_Karelia.svg"),
            new RegionLocalEntry("RU-KRS", "Курская область", "Область", "Курск", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/2/29/Coat_of_arms_of_Kursk_Oblast.svg"),
            new RegionLocalEntry("RU-KYA", "Красноярский край", "Край", "Красноярск", "UTC+7", "https://upload.wikimedia.org/wikipedia/commons/2/29/Coat_of_arms_of_Krasnoyarsk_Krai.svg"),
            new RegionLocalEntry("RU-LEN", "Ленинградская область", "Область", "Санкт-Петербург", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/1/16/Coat_of_arms_of_Leningrad_Oblast.svg"),
            new RegionLocalEntry("RU-LIP", "Липецкая область", "Область", "Липецк", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/9/99/Coat_of_arms_of_Lipetsk_Oblast.svg"),
            new RegionLocalEntry("RU-MAG", "Магаданская область", "Область", "Магадан", "UTC+11", "https://upload.wikimedia.org/wikipedia/commons/b/b0/Coat_of_Arms_of_Magadan_oblast.svg"),
            new RegionLocalEntry("RU-ME", "Республика Марий Эл", "Республика", "Йошкар-Ола", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/3/3a/Coat_of_Arms_of_Mari_El.svg"),
            new RegionLocalEntry("RU-MO", "Республика Мордовия", "Республика", "Саранск", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/6/60/Coat_of_arms_of_Mordovia.svg"),
            new RegionLocalEntry("RU-MOS", "Московская область", "Область", "Красногорск", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/9/9c/Coat_of_arms_of_Moscow_Oblast_%28large%29.svg"),
            new RegionLocalEntry("RU-MOW", "Москва", "Город федерального значения", "Москва", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/1/17/Coat_of_arms_of_Moscow.svg"),
            new RegionLocalEntry("RU-MUR", "Мурманская область", "Область", "Мурманск", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/3/3b/Coat_of_arms_of_Murmansk_Oblast.svg"),
            new RegionLocalEntry("RU-NEN", "Ненецкий автономный округ", "Автономный округ", "Нарьян-Мар", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/4/47/Coat_of_arms_of_Nenets_Autonomous_Okrug.svg"),
            new RegionLocalEntry("RU-NGR", "Новгородская область", "Область", "Великий Новгород", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/1/1a/Coat_of_arms_of_Novgorod_Oblast.svg"),
            new RegionLocalEntry("RU-NIZ", "Нижегородская область", "Область", "Нижний Новгород", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/7/73/Coat_of_arms_of_Nizhny_Novgorod_Region.svg"),
            new RegionLocalEntry("RU-NVS", "Новосибирская область", "Область", "Новосибирск", "UTC+7", "https://upload.wikimedia.org/wikipedia/commons/7/73/Coat_of_arms_of_Novosibirsk_oblast.svg"),
            new RegionLocalEntry("RU-OMS", "Омская область", "Область", "Омск", "UTC+6", "https://upload.wikimedia.org/wikipedia/commons/0/06/Coat_of_arms_of_Omsk_Oblast_%282003-2020%29.svg"),
            new RegionLocalEntry("RU-ORE", "Оренбургская область", "Область", "Оренбург", "UTC+5", "https://upload.wikimedia.org/wikipedia/commons/b/b0/Coat_of_arms_of_Orenburg_Oblast.svg"),
            new RegionLocalEntry("RU-ORL", "Орловская область", "Область", "Орёл", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/c/cb/Coat_of_arms_of_Oryol_Oblast_%28large%29.svg"),
            new RegionLocalEntry("RU-PER", "Пермский край", "Край", "Пермь", "UTC+5", "https://upload.wikimedia.org/wikipedia/commons/1/1b/Coat_of_Arms_of_Perm_Krai.svg"),
            new RegionLocalEntry("RU-PNZ", "Пензенская область", "Область", "Пенза", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/1/10/Coat_of_arms_of_Penza_Oblast.svg"),
            new RegionLocalEntry("RU-PRI", "Приморский край", "Край", "Владивосток", "UTC+10", "https://upload.wikimedia.org/wikipedia/commons/6/65/Coat_of_arms_of_Primorsky_Krai.svg"),
            new RegionLocalEntry("RU-PSK", "Псковская область", "Область", "Псков", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/0/05/Coat_of_arms_of_Pskov_Oblast_%282018%29.svg"),
            new RegionLocalEntry("RU-ROS", "Ростовская область", "Область", "Ростов-на-Дону", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/c/cf/Coat_of_arms_of_Rostov_Oblast.svg"),
            new RegionLocalEntry("RU-RYA", "Рязанская область", "Область", "Рязань", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/0/02/Coat_of_arms_of_Ryazan_Oblast.svg"),
            new RegionLocalEntry("RU-SA", "Республика Саха (Якутия)", "Республика", "Якутск", "UTC+9", "https://upload.wikimedia.org/wikipedia/commons/b/b8/Coat_of_Arms_of_Sakha_%28Yakutia%29.svg"),
            new RegionLocalEntry("RU-SAK", "Сахалинская область", "Область", "Южно-Сахалинск", "UTC+11", "https://upload.wikimedia.org/wikipedia/commons/0/0f/Sakhalin_Oblast_Coat_of_Arms.svg"),
            new RegionLocalEntry("RU-SAM", "Самарская область", "Область", "Самара", "UTC+4", "https://upload.wikimedia.org/wikipedia/commons/5/53/Coat_of_arms_of_Samara_Oblast.svg"),
            new RegionLocalEntry("RU-SAR", "Саратовская область", "Область", "Саратов", "UTC+4", "https://upload.wikimedia.org/wikipedia/commons/5/53/Coat_of_Arms_of_Saratov_oblast.svg"),
            new RegionLocalEntry("RU-SE", "Республика Северная Осетия — Алания", "Республика", "Владикавказ", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/1/1f/Emblem_of_North_Ossetia.svg"),
            new RegionLocalEntry("RU-SMO", "Смоленская область", "Область", "Смоленск", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/0/03/Coat_of_arms_of_Smolensk_Oblast.svg"),
            new RegionLocalEntry("RU-SPE", "Санкт-Петербург", "Город федерального значения", "Санкт-Петербург", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/c/cd/Coat_of_arms_of_Saint_Petersburg_%282003%29.svg"),
            new RegionLocalEntry("RU-STA", "Ставропольский край", "Край", "Ставрополь", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/5/5d/Coat_of_arms_of_Stavropol_Krai.svg"),
            new RegionLocalEntry("RU-SVE", "Свердловская область", "Область", "Екатеринбург", "UTC+5", "https://upload.wikimedia.org/wikipedia/commons/4/40/Coat_of_Arms_of_Sverdlovsk_oblast.svg"),
            new RegionLocalEntry("RU-TA", "Республика Татарстан", "Республика", "Казань", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/9/90/Coat_of_arms_of_Tatarstan.svg"),
            new RegionLocalEntry("RU-TAM", "Тамбовская область", "Область", "Тамбов", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/a/ac/Coat_of_arms_of_Tambov_Oblast.svg"),
            new RegionLocalEntry("RU-TOM", "Томская область", "Область", "Томск", "UTC+7", "https://upload.wikimedia.org/wikipedia/commons/8/89/Coat_of_arms_of_Tomsk_Oblast%2C_Russia.svg"),
            new RegionLocalEntry("RU-TUL", "Тульская область", "Область", "Тула", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/5/5b/Coat_of_Arms_of_Tula_oblast_%282000%29.png"),
            new RegionLocalEntry("RU-TVE", "Тверская область", "Область", "Тверь", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/7/70/Coat_of_arms_of_Tver_Oblast.svg"),
            new RegionLocalEntry("RU-TY", "Республика Тыва", "Республика", "Кызыл", "UTC+7", "https://upload.wikimedia.org/wikipedia/commons/c/c3/Coat_of_arms_of_Tuva.svg"),
            new RegionLocalEntry("RU-TYU", "Тюменская область", "Область", "Тюмень", "UTC+5", "https://upload.wikimedia.org/wikipedia/commons/2/2a/Coat_of_Arms_of_Tyumen_Oblast.svg"),
            new RegionLocalEntry("RU-UD", "Удмуртская Республика", "Республика", "Ижевск", "UTC+4", "https://upload.wikimedia.org/wikipedia/commons/0/0a/Coat_of_arms_of_Udmurtia.svg"),
            new RegionLocalEntry("RU-ULY", "Ульяновская область", "Область", "Ульяновск", "UTC+4", "https://upload.wikimedia.org/wikipedia/commons/e/ee/%D0%93%D0%B5%D1%80%D0%B1_%D0%A3%D0%BB%D1%8C%D1%8F%D0%BD%D0%BE%D0%B2%D1%81%D0%BA%D0%BE%D0%B9_%D0%BE%D0%B1%D0%BB%D0%B0%D1%81%D1%82%D0%B8_%282013%29.svg"),
            new RegionLocalEntry("RU-VGG", "Волгоградская область", "Область", "Волгоград", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/5/54/Coat_of_Arms_of_Volgograd_oblast.svg"),
            new RegionLocalEntry("RU-VLA", "Владимирская область", "Область", "Владимир", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/e/ef/Coat_of_arms_of_Vladimir_Oblast.svg"),
            ...
            new RegionLocalEntry("RU-VOR", "Воронежская область", "Область", "Воронеж", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/2/2a/Coat_of_arms_of_Voronezh_Oblast.svg"),
            new RegionLocalEntry("RU-YAN", "Ямало-Ненецкий автономный округ", "Автономный округ", "Салехард", "UTC+5", "https://upload.wikimedia.org/wikipedia/commons/d/d0/Coat_of_Arms_of_Yamal_Nenetsia.svg"),
            new RegionLocalEntry("RU-YAR", "Ярославская область", "Область", "Ярославль", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/4/48/Coat_of_arms_of_Yaroslavl_Oblast.svg"),
            new RegionLocalEntry("RU-YEV", "Еврейская автономная область", "Автономная область", "Биробиджан", "UTC+10", "https://upload.wikimedia.org/wikipedia/commons/c/ce/Coat_of_arms_of_Jewish_Autonomous_Oblast.svg"),
            new RegionLocalEntry("RU-ZAB", "Забайкальский край", "Край", "Чита", "UTC+9", "https://upload.wikimedia.org/wikipedia/commons/6/6a/Coat_of_arms_of_Zabaykalsky_Krai.svg"),
            new RegionLocalEntry("RU-CR", "Республика Крым", "Республика", "Симферополь", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/c/c8/Emblem_of_Crimea.svg"),
            new RegionLocalEntry("RU-SEV", "Севастополь", "Город федерального значения", "Севастополь", "UTC+3", "https://upload.wikimedia.org/wikipedia/commons/a/ab/COA_of_Sevastopol.svg")
    );
    ...
    private void saveOrUpdateRegion(GeoRegionData geoData, Country russia, LoadAccumulator acc) {
        ...
        if (existing != null) {
            ...
            // Обновляем ISO-код, если его ещё нет (старые записи без кода)
            if (geoData.getIsoCode() != null && region.getIsoCode() == null) {
                region.setIsoCode(geoData.getIsoCode().toUpperCase());
            }
            acc.updated++;
        } else {
