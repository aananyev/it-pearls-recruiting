    ...
    public void testBrowseLoadProject() {
        ...
        List<Project> projects = dataManager.loadList(LoadContext.create(Project.class)
                .setQuery(LoadContext.createQuery(
                        "select e from hunttech_Project e where e.id = :id")
    ...
    public void testSoftDeleteProject() {
        ...
        try (Transaction tx = persistence.createTransaction()) {
            Project deleted = persistence.getEntityManager()
                    .createQuery("select e from hunttech_Project e where e.id = :id", Project.class)
                    .setParameter("id", id)
                    .getSingleResult();
            tx.commit();
        ...
        List<Project> active = dataManager.loadList(LoadContext.create(Project.class)
                .setQuery(LoadContext.createQuery(
                        "select e from hunttech_Project e where e.id = :id and e.deleteTs is null")
                        .setParameter("id", id))
                .setView(View.LOCAL));
