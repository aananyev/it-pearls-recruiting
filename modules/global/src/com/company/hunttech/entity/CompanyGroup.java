...
@Table(name = "HUNTTECH_COMPANY_GROUP", indexes = {
        @Index(name = "IDX_HUNTTECH_COMPANY_GROUP_RU_NAME", columnList = "COMPANY_RU_GROUP_NAME")
})
@Entity(name = "hunttech_CompanyGroup")
