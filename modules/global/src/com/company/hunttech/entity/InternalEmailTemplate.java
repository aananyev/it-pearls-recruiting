...
@Table(name = "HUNTTECH_INTERNAL_EMAIL_TEMPLATE", indexes = {
        @Index(name = "IDX_HUNTTECH_INTERNAL_EMAIL_TEMPLATE_OPEN_POSITION", columnList = "TEMPLATE_OPEN_POSITION_ID"),
        @Index(name = "IDX_HUNTTECH_INTERNAL_EMAIL_TEMPLATE_AUTHOR", columnList = "TEMPLATE_AUTHOR_ID"),
        @Index(name = "IDX_HUNTTECH_INTERNAL_EMAIL_TEMPLATE_POSITION", columnList = "TEMPLATE_POSITION_ID")
})
@Entity(name = "hunttech_InternalEmailTemplate")
