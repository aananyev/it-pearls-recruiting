...
@Table(name = "HUNTTECH_INTERNAL_EMAILER", indexes = {
        @Index(name = "IDX_HUNTTECH_INTERNAL_EMAILER_TO_EMAIL", columnList = "TO_EMAIL_ID"),
        @Index(name = "IDX_HUNTTECH_INTERNAL_EMAILER_FROM_EMAIL", columnList = "FROM_EMAIL_ID"),
        @Index(name = "IDX_HUNTTECH_INTERNAL_EMAILER_EMAIL_TEMPLATE", columnList = "EMAIL_TEMPLATE_ID"),
        @Index(name = "IDX_HUNTTECH_INTERNAL_EMAILER_REPLY_INTERNAL_EMAILER", columnList = "REPLY_INTERNAL_EMAILER_ID")
})
@Entity(name = "hunttech_InternalEmailer")
