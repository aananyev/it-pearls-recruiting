...
@Table(name = "HUNTTECH_JOB_CANDIDATE_SIGN_ICON", indexes = {
        @Index(name = "IDX_HUNTTECH_JOB_CANDIDATE_SIGN_ICON_JOB_CANDIDATE", columnList = "JOB_CANDIDATE_ID"),
        @Index(name = "IDX_HUNTTECH_JOB_CANDIDATE_SIGN_ICON_SIGN_ICON", columnList = "SIGN_ICON_ID"),
        @Index(name = "IDX_HUNTTECH_JOB_CANDIDATE_SIGN_ICON_USER", columnList = "USER_ID")
})
@Entity(name = "hunttech_JobCandidateSignIcon")
