...
@Table(name = "HUNTTECH_LABOR_AGEEMENT_TYPE", indexes = {
        @Index(name = "IDX_HUNTTECH_LABOR_AGEEMENT_TYPE_NAME", columnList = "NAME_AGREEMENT")
})
@Entity(name = "hunttech_LaborAgeementType")
