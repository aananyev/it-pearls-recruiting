...
@Table(name = "HUNTTECH_OPEN_POSITION", indexes = {
        @Index(name = "IDX_HUNTTECH_OPEN_POSITION_OPEN_CLOSE", columnList = "OPEN_CLOSE"),
        @Index(name = "IDX_HUNTTECH_OPEN_POSITION_PRIORITY", columnList = "PRIORITY"),
        @Index(name = "IDX_HUNTTECH_OPEN_POSITION_VACANSY_NAME", columnList = "VACANSY_NAME")
})
@Entity(name = "hunttech_OpenPosition")
public class OpenPosition extends StandardEntity {
    ...
    @Length(message = "{msg://hunttech_OpenPosition.shortDescription.validation.Length}", max = 250)
    ...
    @JoinTable(name = "HUNTTECH_OPEN_POSITION_RECRUTIES_TASKS_LINK", joinColumns = @JoinColumn(name = "OPEN_POSITION_ID"), inverseJoinColumns = @JoinColumn(name = "RECRUTIES_TASKS_ID"))
    @ManyToMany
    @OnDelete(DeletePolicy.DENY)
    ...
    @JoinTable(name = "HUNTTECH_OPEN_POSITION_LABOR_AGREEMENT_LINK",
