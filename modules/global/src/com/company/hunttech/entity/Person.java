...
@Table(name = "HUNTTECH_PERSON", indexes = {
        @Index(name = "IDX_HUNTTECH_PERSON_FIRST_NAME", columnList = "FIRST_NAME"),
        @Index(name = "IDX_HUNTTECH_PERSON_MIDDLE_NAME", columnList = "MIDDLE_NAME"),
        @Index(name = "IDX_HUNTTECH_PERSON_SECOND_NAME", columnList = "SECOND_NAME")
})
@Entity(name = "hunttech_Person")
