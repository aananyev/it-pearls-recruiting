...
@Table(name = "HUNTTECH_POSITION", indexes = {
        @Index(name = "IDX_HUNTTECH_POSITION_RU_NAME", columnList = "POSITION_RU_NAME"),
        @Index(name = "IDX_HUNTTECH_POSITION_EN_NAME", columnList = "POSITION_EN_NAME")
})

@Entity(name = "hunttech_Position")
