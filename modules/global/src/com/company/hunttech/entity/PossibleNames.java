...
@Table(name = "HUNTTECH_POSSIBLE_NAMES", indexes = {
        @Index(name = "IDX_HUNTTECH_POSSIBLE_NAMES_EN_NAME_POSITION", columnList = "POSSIBLE_EN_NAME_POSIION"),
        @Index(name = "IDX_HUNTTECH_POSSIBLE_NAMES_POSSIBLE_NAME", columnList = "POSSIBLE_NAME")
})
@Entity(name = "hunttech_PossibleNames")
