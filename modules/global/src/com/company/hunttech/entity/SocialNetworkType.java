...
@Table(name = "HUNTTECH_SOCIAL_NETWORK_TYPE", indexes = {
        @Index(name = "IDX_HUNTTECH_SOCIAL_NETWORK_TYPE_SOCIAL_NETWORK", columnList = "SOCIAL_NETWORK")
})
@Entity(name = "hunttech_SocialNetworkType")
