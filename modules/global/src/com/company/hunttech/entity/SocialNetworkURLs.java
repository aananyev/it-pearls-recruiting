...
@Table(name = "HUNTTECH_SOCIAL_NETWORK_UR_LS", indexes = {
        @Index(name = "IDX_NETWORK_NAME", columnList = "NETWORK_NAME"),
        @Index(name = "IDX_HUNTTECH_SOCIAL_NETWORK_U_R_LS", columnList = "NETWORK_URLS")
})
@Entity(name = "hunttech_SocialNetworkURLs")
