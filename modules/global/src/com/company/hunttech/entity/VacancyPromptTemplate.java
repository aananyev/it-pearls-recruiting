...
@Table(name = "HUNTTECH_VACANCY_PROMPT_TEMPLATE", indexes = {
        @Index(name = "IDX_HUNTTECH_VACANCY_PROMPT_TEMPLATE_CODE", columnList = "CODE", unique = true)
})
@Entity(name = "hunttech_VacancyPromptTemplate")
