 ...
 *
 * <p>Навыки опыта в годах («1 год», «2 года», …, «N лет») нейросеть возвращает ровно
 * один — соответствующий общему стажу кандидата (см. системный промпт SKILLS_EXTRACT);
 * сервис дополнительно схлопывает их до одного (страховка от нескольких значений).
 * Если AI определил цифру опыта, которой нет в справочнике (например, «21 год»),
 * пишется отдельный WARN-лог для администратора.</p>
 *
 * <p>Уровни анализа:</p>
 * <ul>
