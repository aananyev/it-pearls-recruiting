...
public interface TextProcessingService {
     ...
     * с сохранением полного содержания. В процессе форматирования удаляются все пустые
     * строки (в том числе строки из одних пробелов): итоговый HTML не содержит пустых строк.
     *
     ...
     * Пустые строки исходника удаляются; секции разделяются заголовками {@code ═══ … ═══}.
     *
     * @param rawText исходный текст
