...
/**
 * DTO агрегированных KPI метрик для экрана мониторинга фонового определения навыков.
 */
public class CandidateSkillsEnrichmentKpiDto implements Serializable {
    ...
    public void setProviderModelStats(List<ProviderModelStatDto> providerModelStats) {
        this.providerModelStats = providerModelStats != null ? providerModelStats : new ArrayList<>();
    }
}
