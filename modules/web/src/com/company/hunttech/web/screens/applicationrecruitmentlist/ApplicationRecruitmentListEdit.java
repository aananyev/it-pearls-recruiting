...
@UiController("hunttech_ApplicationRecruitmentList.edit")
...
public class ApplicationRecruitmentListEdit extends StandardEditor<ApplicationRecruitmentList> {
    ...
    public void automatingFillButton() {
        if (codeTextField.getValue() != null) {
            final String QUERY_STAFFING_TABLE
                    = "select e from hunttech_StaffingTable e where e.active = true";
            final String QUERY_STAFF_CURRENT
                    = "select e from hunttech_StaffCurrent e where e.staffingTable = :staffingTable";
    ...
    public void automatingFillFromProjectButton() {
        if (projectDepartmentLookupPicketField.getValue() != null) {
            if (codeTextField.getValue() != null) {
                final String QUERY_STAFFING_TABLE
                        = "select e from hunttech_StaffingTable e " +
                        "where e.active = true and e.openPosition.projectName = :projectName";
                final String QUERY_STAFF_CURRENT
                        = "select e from hunttech_StaffCurrent e " +
