...
@UiController("hunttech_InternalEmailer.edit")
...
public class InternalEmailerEdit<I extends InternalEmailer> extends StandardEditor<InternalEmailer> {
    ...
    private final static String QUERY_GET_DEFAULT_OPEN_POSITION = "select e from hunttech_OpenPosition e where e.vacansyName like 'Default'";
    private final static String QUERY_GET_INTERACTION_SIGN_EMAIL_SEND = "select e from hunttech_Iteraction e where e.signEmailSend = true";
    private final static String QUERY_GEM_MAX_NUMBER_INTERACTION = "select max(e.numberIteraction) from hunttech_IteractionList e";
