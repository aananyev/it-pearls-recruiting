package com.company.hunttech.web.screens.interviewcalendar;
...
@UiController("hunttech_WeekInterviewCalendar")
    ...
    private void setCalendarEventListener() {
        interviewCalendar.addEventClickListener(dateCalendarEventClickEvent -> {
            ...
            IteractionList iteractionList = dataManager.load(IteractionList.class)
                    .query("select e from hunttech_IteractionList e where e.addDate = :dateIteraction and e.candidate = (select f from hunttech_JobCandidate f where f.fullName like :candidate)")
