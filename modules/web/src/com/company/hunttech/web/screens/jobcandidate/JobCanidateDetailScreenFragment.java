...
@UiController("hunttech_JobCanidateDetailScreenFragment")
...
public class JobCanidateDetailScreenFragment extends ScreenFragment {
    ...
    private static final String QUERY_ALL_CV = "select e from hunttech_CandidateCV e " +
            "where e.candidate = :candidate ";
    private static final String QUERY_ALL_ITERACIONS = "select e from hunttech_IteractionList e " +
            "where e.candidate = :candidate " +
            "order by e.dateIteraction desc";
    private static final String QUERY_LAST_SALARY = "select e from hunttech_IteractionList e where e.iteractionType = " +
            ...
            if (iList.getIteractionType() != null) {
                if (iList.getIteractionType().getSignOurInterview() != null) {
                    if (iList.getIteractionType().getSignOurInterview()) {
                        ...
                        if (days != 0) {
                            countAfterHuntTechInterview.setValue(new StringBuilder()
