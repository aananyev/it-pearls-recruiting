package com.company.hunttech.web.screens.jobcandidate.jobcandidatecomments;

import com.company.hunttech.core.StarsAndOtherService;
import com.company.hunttech.entity.*;
import com.company.hunttech.web.JobCandidateCommentEvent;
import com.company.hunttech.web.screens.fragments.jobcandidatecommentfragment.JobCandidateCommentFragment;
...
@UiController("hunttech_JobCandidateComment")
                                ...
                                .withField(() -> {
                                    ...
                                    openPositionLookupField.setOptionsList(
                                            dataManager.load(OpenPosition.class)
                                                    .query("select e from hunttech_OpenPosition e where not e.openClose = true")
                                                    .list());
