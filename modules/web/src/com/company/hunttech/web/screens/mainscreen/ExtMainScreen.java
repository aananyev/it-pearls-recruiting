...
public class ExtMainScreen extends MainScreen {
    ...
    static final String QUERY_GET_ITERACTIONS_FOR_NOTIFICATIONS =
            "select e from hunttech_IteractionList e " +
                    ...
                    "   from hunttech_IteractionList g " +
                    "   where g.candidate = e.candidate) " +
                    "and e.iteractionType in " +
                    "(select f from hunttech_Iteraction f where f.notificationNeedSend = true)";
