...
import com.company.hunttech.web.screens.openposition.openpositionviews.TextViewScreen;
...
@UiController("hunttech_OpenPositionMaster.browse")
...
//                projectNameDl.setParameter("company", companyTable.getSingleSelected());
    ...
    private static final String QUERY_MIN_MAX_SALARY = "select e from hunttech_OpenPosition e where e.positionType = :position and (not e.openClose = true)";
