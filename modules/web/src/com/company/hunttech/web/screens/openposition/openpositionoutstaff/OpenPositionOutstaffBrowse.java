package com.company.hunttech.web.screens.openposition.openpositionoutstaff;
...
import com.company.hunttech.web.screens.openposition.openpositionfragments.OpenPositionOutstaffDetailScreenFragment;
...
@UiController("hunttech_OpenPositionOutstaff.browse")
@UiDescriptor("open-position-outstaff-browse.xml")
public class OpenPositionOutstaffBrowse extends OpenPositionBrowse {
    private static final String QUERY_GET_DEFAULT_GRADE = "select e from hunttech_Grade e where e.gradeName like 'Default'";
    private static final String QUERY_STAFF_CURRENTS = "select e from hunttech_StaffCurrent e";
    private static final String QUERY_STAFF_TABLE = "select e from hunttech_StaffingTable e";
