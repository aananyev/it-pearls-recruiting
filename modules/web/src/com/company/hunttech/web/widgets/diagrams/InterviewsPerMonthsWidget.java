...
@UiController("hunttech_InterviewsPerMonthsWidget")
...
public class InterviewsPerMonthsWidget extends ScreenFragment {
    ...
    private static final String QUERY_ASSIGNED_COUNT =
    ...
    private void setAssignedInterviewToday() {
        ...
        Long count = dataManager.loadValue(QUERY_ASSIGNED_COUNT, Long.class)
