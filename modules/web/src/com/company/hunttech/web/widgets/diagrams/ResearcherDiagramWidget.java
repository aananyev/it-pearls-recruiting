package com.company.hunttech.web.widgets.diagrams;
...
@UiController("hunttech_ResearcherDiagramWidget")
...
public class ResearcherDiagramWidget extends ScreenFragment {
    ...
    private static final String QUERY_DAY_COUNT_BY_TYPE =
            "select count(f) from hunttech_IteractionList f " +
                    "where f.dateIteraction >= :startDate and f.dateIteraction < :endDate and " +
                    "f.iteractionType = (select e from hunttech_Iteraction e where e.iterationName like :iteractionName)";
    ...
    private static final String ITRKT_ASSIGN_ITPEARKS_INTERVIEW = "Назначено собеседование с рекрутером HuntTech";
    private static final String ITRKT_PREPARE_ITPEARKS_INTERVIEW = "Прошел собеседование с рекрутером HuntTech";
