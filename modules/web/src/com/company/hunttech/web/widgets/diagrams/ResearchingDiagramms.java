...
@UiController("hunttech_ResearchingDiagramms")
...
public class ResearchingDiagramms extends ScreenFragment {
    ...
    private static final String QUERY_GET_ITERACTIONS =
            "select f from hunttech_Iteraction f where f.iterationName like :iteractionName";
    ...
    @WidgetParam
    @WindowParam
    protected String internalInterview = "Назначено собеседование с рекрутером HuntTech";
