...
@UiController("hunttech_MonthlyInterviewCountWidget")
...
public class MonthlyInterviewCountWidget extends ScreenFragment {
    ...
    private static final String QUERY_INTERACTION_COUNT =
            "select count(e) from hunttech_IteractionList e " +
    ...
    private String itemAssignInternalInterview = "Назначено собеседование с рекрутером HuntTech";
    private String itemPrepareInternalInterview = "Прошел собеседование с рекрутером HuntTech";
