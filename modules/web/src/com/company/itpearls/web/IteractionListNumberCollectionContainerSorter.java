...
public class IteractionListNumberCollectionContainerSorter extends CollectionContainerSorter {
    public IteractionListNumberCollectionContainerSorter(CollectionContainer container, @Nullable BaseCollectionLoader loader) {
    ...
    protected Comparator<? extends Entity> createComparator(Sort sort, MetaClass metaClass) {
        ...
        if (metaPropertyPath.getMetaClass().getJavaClass().equals(IteractionList.class)
                && "numberIteraction".equals(metaPropertyPath.toPathString())) {
