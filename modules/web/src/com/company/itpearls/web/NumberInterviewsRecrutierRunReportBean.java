...
@Component(NumberInterviewsRecrutierRunReportBean.NAME)
public class NumberInterviewsRecrutierRunReportBean {
    public static final String NAME = "itpearls_NumberInterviewsRecrutierRunReportBean";
