...
public class StandartPrioritySkills {
    ...
    public final static String DEFAULT_STR = "Default";
    public final static Integer DEFAULT_INT = 0;
    public final static String DEFAULT_STYLE = "label_button_blue";

    public final static String SUBJECT_AREA_STR = "Subject Area";
    public final static Integer SUBJECT_AREA_INT = 1;
    public final static String SUBJECT_AREA_STYLE = "label_button_green";

    public final static String FRAMEWORKS_STR = "Frameworks";
    public final static Integer FRAMEWORKS_INT = 2;
    public final static String FRAMEWORKS_STYLE = "label_button_brown";

    public final static String METHODOLOGY_STR = "Methodolory";
