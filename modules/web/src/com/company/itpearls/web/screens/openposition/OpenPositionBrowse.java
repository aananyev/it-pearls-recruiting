...
public class OpenPositionBrowse extends StandardLookup<OpenPosition> {
    ...
    private Object openPositionsTableProjectLogoColumnColumnGenerator(DataGrid.ColumnGeneratorEvent<OpenPosition> event) {
        ...
        image.setHtmlSanitizerEnabled(false);
...
//                    .append("</b><br><svg align=\"right\" width=\"100%\"><i>")
    ...
    public void onBeforeShow(BeforeShowEvent event) {
        ...
        Boolean getRoleManager = getRoleService.isUserRoles(userSession.getUser(), StandartRoles.MANAGER);
        buttonExcel.setEnabled(getRoleManager);
...
//                    logoImage.setDescription(textManipulationService.getImage(event.getItem().getPositionType().getLogo()));
    ...
    private Image setProjectOwnerImage(Person projectOwner) {
        ...
        retImage.setHtmlSanitizerEnabled(false);
